...
marvel_club = Club.create!(name: "Marvel Movies Club ", meeting_time: 'December 11, 2020', description: Faker::Lorem.paragraphs(number: 1), image: 'https://www.slashfilm.com/wp/wp-content/images/marvel-intro-e1556625768997.jpg')
