...
user0 = User.create!(username: "user1", password: "1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")
user1 = User.create!(username: "user2", password: "1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://www.rd.com/wp-content/uploads/2017/09/01-shutterstock_476340928-Irina-Bg.jpg")
user2 = User.create!(username: "user3", password: "1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://perfectczechwomen.com/wp-content/uploads/2019/04/New-Profile-20-500x536.jpg")
user3 = User.create!(username: "user4", password: "1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://i.insider.com/59b6b9b6f7f1f622008b47e9?width=600&format=jpeg&auto=webp")
user4 = User.create!(username: "user5", password: "1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://lh3.googleusercontent.com/proxy/7Lk6xvrPTfVFM8Kb9rysxtrKgFuRW_7sR8MCdVobiQjhTA61rtK5GRT8jAxCKtRp1vjBJSRE62feLrnJWwRYuy4Bu4vD5gCCBbhAshrTMNhDVD-3_IONP3LXbmBv_cMoHCteG4s")
user5 = User.create!(username: "user6", password: "1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://www4.pictures.zimbio.com/gi/39th+Annual+People+Choice+Awards+Portraits+lza8vaU_QsZx.jpg" )
user6 = User.create!(username: "user7", password: "1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://img-cdn.tid.al/o/6dc39fec4427c4f9f759c1f2c44137bec7366e4c.png" )
user7 = User.create!(username: "user8", password: "1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://lh3.googleusercontent.com/proxy/pAeLbKbOFAutI1n4wWr6yOhTZY_TPl3S6N3QaGfiDFRaP9GIDvWcNdFa_HlDkvh4DKZd7RWWz8oaWnrG-suZzlYL8bGKG5PWUnpLJIapJfZ8v8GslbBxzohfI9bryvu5M-w")
user8 = User.create!(username: "user9", password: "1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://vengreso.com/wp-content/uploads/2016/03/LinkedIn-Profile-Professional-Picture-Sample-Bernie-Borges.png")
user9 = User.create!(username: "user10", password:"1234", name: Faker::Name.unique.name, age: Faker::Number.between(from: 1, to: 100), email: Faker::Internet.email, profile_image: "https://www.bigredcloud.com/wp-content/uploads/4-tips-for-taking-professional-profile-pictures.jpg")
